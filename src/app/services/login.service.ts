...
export class LoginService {
  ...
  adminRegister(data): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/register", data)
  }

  //Admin Login
  adminLogin(data): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/login", data);
  }

  //Forget Password
  forgotPassword(data): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/forgetpassword", data);
  }

  //Change Password
  changePassword(data): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/changepassword", data);
  }
  //Change Patient Password
  //http://34.199.165.142:3000/api/patient/generalinfo/changepassword
  changePatientPassword(data): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/generalinfo/setpassword", data);
  }
  adminResetPassword(data): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/setpassword", data);
  }
  ...
  getMedicalPersonnelData(fetchMedicalPersonnelData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/getmedicalpersonnels", fetchMedicalPersonnelData, { headers: { 'x-access-token': accessToken } });
  }


  //Add Hospital Departments Data
  addHospitalDepartmentsData(addHospitalDepartmentDataObj, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/departments",
  ...
  getHospitalDepartmentsData(fetchHospitalDepartmentDataObj, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/departments/fetch",
  ...
  addAdministrativeRolesData(addAdministrativeRolesDataObj, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/administrativeroles",
  ...
  getAdministrativeRolesData(fetchAdministrativeRolesDataObj, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/administrativeroles/fetch",
  ...
  deleteServicesData(deleteServicesDataObj, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/services", options);
  }
  ...
  getMedicalPatientData(mpData): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/hospital/getmedicalpersonnels", options, { headers: { 'x-access-token': token } });
  }
  ...
  getPatientFamilyHistoryData(data): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/familyhistory/fetch",
  ...
  addPatientFamilyHistoryData(addPatientFamilyHistory, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/familyhistory/multiple",
  ...
  addPatientIllnessMedicationManualData(addPatientMedicationManualData, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/medication/manually",
  ...
  addHospitalWebSitesData(addWebSitesData, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/hospital/updatewebsites",
      addWebSitesData, { headers: { 'x-access-token': accessToken } });
  }

  //http://34.199.165.142:3000/api/patient/medicalrecord/illness/medication/fetchall
  ...
  deletePatientFamilyHistoryData(deletePatientFamilyHistory, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/familyhistory/all", options);
  }
  ...
  getPatientAllergiesData(data): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/allergies/fetch", options, { headers: { 'x-access-token': access_token } });
  }
  ...
  addPatientAllergiesData(addPatientAllergies, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/allergies/multiple",
  ...
  deletePatientAllergiesData(deletePatientAllergies, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/allergies/all", options);
  }
  ...
  addPatientPhysicalExamRecordsManually(addPatPhyExamRecordsManullyData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/physicalexamrecord",
  ...
  addAdminPersonalSettings(addAdminPersonalSettingsData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/adminpersonalsettings",
  ...
  addPatientImmunizationData(addPatImmunizationData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/immunization",
  ...
  addPatientIllnessDiagnosisData(addPatIllDiagnosisData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/diagnosisNotes/",
  ...
  editPatientIllnessDiagnosisData(editPatIllDiagnosisData, accessToken): any {
    return this._http.put("http://34.199.165.142:3000/api/patient/medicalrecord/illness/diagnosisNotes/",
  ...
  addPatientMedicalRecordIllnessData(addPatMedicalRecordIllnessData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness",
  ...
  updatePatientImmunizationData(editImmunizationData, accessToken): any {
    return this._http.put("http://34.199.165.142:3000/api/patient/immunization",
  ...
  updatePatientIllnessData(editedIllnessData, accessToken): any {
    return this._http.put("http://34.199.165.142:3000/api/patient/medicalrecord/illness",
  ...
  updatePatientPhysicalExamRecordsManually(updatePatPhyExamRecordsManullyData, accessToken): any {
    ...
    return this._http.put("http://34.199.165.142:3000/api/patient/physicalexamrecord",
  ...
  getPatientPhysicalExamRecordsData(fetchPatientPhysicalExamRecords, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/physicalexamrecord/fetch",
  ...
  getPatientImmunizationRecordsData(fetchPatientImmunizationRecords, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/immunization/fetch",
  ...
  getPatientMedicalRecordsIllnessData(fetchPatientMedicalRecordsIllness, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/fetchall",
  ...
  getPatientMedicationsData(fetchPatientMedicationsDataObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/medication/fetch_all_by_patientID",
  ...
  getPatientSurgicalRecordsData(fetchPatientSurgicalRecordsObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/surgicalrecord/fetch_all_by_patientID",
  ...
  deletePatientPhysicalExamRecordData(deletePatientRecord, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/physicalexamrecord", options);
  }
  ...
  deletePatientRecordData(deletePatientRecord, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/generalinfo", options);
  }
  ...
  deletePatientImmunizationRecordData(deletePatientImmunizationRecord, accessToken): any {
    ...
    console.log("Delete Patien Phy exam record Data : ", options);
    return this._http.delete("http://34.199.165.142:3000/api/patient/immunization", options);
  }
  ...
  deletePatientIllnessRecordData(deletePatientIllRecord, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/medicalrecord/illness", options);
  }
  ...
  deletePatientIllnessDiagnosticData(deletePatientIllRecord, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/medicalrecord/illness/diagnosisNotes/all", options);
  }
  ...
  deletePatientIllnessMedicationData(deletePatientIllRecord, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/medicalrecord/illness/medication/all", options);
  }
  ...
  deletePatientIllnessMedicationDataSingle(deletePatientIllRecord, accessToken): any {
    ...
    console.log("Delete Patien Medications Data : ", options);
    return this._http.delete("http://34.199.165.142:3000/api/patient/medicalrecord/illness/medication", options);
  }
  ...
  deletePatientSurgicalRecordDataSingle(deletePatientIllRecord, accessToken): any {
    ...
    console.log("Delete Patien Medications Data : ", options);
    return this._http.delete("http://34.199.165.142:3000/api/patient/medicalrecord/illness/surgicalrecord/", options);
  }
  ...
  deletePatientIllnessSurgicalProcedureData(deletePatientIllRecord, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/medicalrecord/illness/surgicalrecord/all", options);
  }
  ...
  getHospitalAppointmentsData(fetchHospitalAppointmentsRecordsObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/appointments/allappointmentsforhospital",
  ...
  getPatientAppointmentsData(fetchPatientAppointmentsRecords, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/appointments/allappointmentsforPatient",
  ...
  getPatientScreeningRecordsData(fetchPatientScreeningRecords, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/screeningrecord/fetchall",
  ...
  getPatientTestResultsData(fetchPatientTestResultsObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/testresult/fetch",
  ...
  deletePatientScreeningRecordsData(deletePatientFile, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/medicalrecord/screeningrecord", options);
  }

  addPatientPhysicalExamRecordAttachmentData(addPatPhyExamAttachmentData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/physicalexamrecord/attachment", addPatPhyExamAttachmentData, { headers: { 'x-access-token': accessToken } });
  ...
  addPatientScreeningRecordsData(addPatientScreeningRecordData, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/screeningrecord", addPatientScreeningRecordData, { headers: { 'x-access-token': accessToken } });
  }
  ...
  deleteAllPatientPhysicalExamRecordsData(deletePatientAllFile, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/patient/physicalexamrecord/all", options);
  }
  ...
  deletePatientInfo(pInfo): any {
    ...
    console.log("Delete Patien Data : ", options);
    return this._http.delete("http://34.199.165.142:3000/api/patient/generalinfo", options);
    //return this._http.delete("http://34.199.165.142:3000/api/patient/generalinfo",op);
  }

  //Update Patient Data
  updatePatient(patientData, accessToken): any {
    return this._http.put("http://34.199.165.142:3000/api/patient/generalinfo", patientData, { headers: { 'x-access-token': accessToken } });
  }

  //Fetch Patient Ill Medication Records Data 
  fetchPatientMedicationData(fetchPatMEdicationDataObj, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/medication/fetchall",
  ...
  fetchPatientSurgicalData(fetchPatSurgicalDataObj, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/surgicalrecord/fetchall",
  ...
  fetchPatientDiagnosisData(fetchPatDiagnosisDataObj, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/diagnosisNotes/fetchall",
  ...
  addPatientMedicalHistoryIllnessMedicationAttachment(patientData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/medication/attachment",
  ...
  addPatIllSurgicalFormData(surgicalData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/illness/surgicalrecord",
  ...
  addAdminGenUser(addAdminGenData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/hospital/admingeneraluser", addAdminGenData, { headers: { 'x-access-token': accessToken } });
  }

  //Add Patient Gen info
  addPatientGenInfo(addPatGenInfoData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/generalinfo", addPatGenInfoData, { headers: { 'x-access-token': accessToken } });
  }
  ...
  updateAdminGenUser(updateAdminGenData, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/hospital/updateadmin", updateAdminGenData, { headers: { 'x-access-token': accessToken } });
  }
  ...
  updateAdmin(adminData, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/hospital/update", adminData, { headers: { 'x-access-token': accessToken } });
  }
  ...
  deleteAdminGenUser(deleteAdminGenData, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/hospital/deleteadmin", needToDelete, { headers: { 'x-access-token': accessToken } });

  }

  //Get Patient Medical Records Data
  getPatientMedicalRecordsData(pDataForMedicalRecords, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/patient/medicalrecord/fetch", pDataForMedicalRecords, { headers: { 'x-access-token': accessToken } });
  }

  //Get Admin/Hospital Appointment  Data
  getAdminAppointmentData(fetchAppointmentData, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/appointments/allappointmentsforhospital", fetchAppointmentData, { headers: { 'x-access-token': accessToken } });
  }

  //Cancel Appointment
  cancelAppointment(reqDataForCancelAppointment, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/appointments/cancelappointment", reqDataForCancelAppointment, { headers: { 'x-access-token': accessToken } });
  }

  //Reschedule Appointment
  rescheduleAppointment(reqDataForRescheduleAppointment, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/appointments/appointmentreschedule", reqDataForRescheduleAppointment, { headers: { 'x-access-token': accessToken } });
  }

  //Book Appointment
  bookAppointmentService(reqDataForBookAppointment, accessToken): any {
    return this._http.post("http://34.199.165.142:3000/api/appointments/bookappointment", reqDataForBookAppointment, { headers: { 'x-access-token': accessToken } })
  }
  ...
  addInvoiceData(addInvoiceDataObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/invoice",
  ...
  updateInvoiceData(updateInvoiceDataObj, accessToken): any {
    ...
    return this._http.put("http://34.199.165.142:3000/api/invoice",
  ...
  fetchInvoicesData(fetchInvoicesDataObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/invoice/byhospitalid",
  ...
  //   return this._http.post("http://34.199.165.142:3000/api/invoice/byinvoiceid",
  ...
  deleteInvoicesData(deleteInvoicesDataObj, accessToken): any {
    ...
    return this._http.delete("http://34.199.165.142:3000/api/invoice/byinvoiceid", options);
  }
  ...
  sendInvoiceData(sendInvoiceDataObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/invoice/sendtoclient",
  ...
  sendReminderInvoiceData(sendReminderInvoiceDataObj, accessToken): any {
    ...
    return this._http.post("http://34.199.165.142:3000/api/invoice/remindtoclient",
